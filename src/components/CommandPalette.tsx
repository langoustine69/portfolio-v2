...
const pages: CommandItem[] = [
  ...
  { id: 'use-cases', title: 'Use Cases', subtitle: 'Real-world applications', icon: '💡', type: 'page', href: '/use-cases' },
  ...
  { id: 'earnings', title: 'Earnings Dashboard', subtitle: 'x402 revenue & $DREAMS', icon: '💰', type: 'page', href: '/earnings' },
