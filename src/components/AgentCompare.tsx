          ...
          {selectedIds.length > 0 && (
            <div className="flex items-center gap-4">
              {selectedIds.length >= 2 && (
                <Link
                  href={`/compare/deep/${selectedIds.join('/')}`}
                  className="flex items-center gap-1.5 text-sm bg-lobster-600 hover:bg-lobster-500 text-white px-3 py-1.5 rounded-lg transition-colors"
                >
